---
title: M5StickVの初期設定
permalink: /M5StickVの初期設定
---
# [M5StickVの初期設定](/M5StickVの初期設定)

[M5Stick](/M5Stick)VはM5Stackの小型版([M5Stick](/M5Stick))の、さらにAIエンジン搭載のもの、らしい。情報がなく、いろいろ苦労する。
...
uPyLoaderで[M5Stick](/M5Stick)Vからファイルを転送するのには成功したが、逆はうまくいかない。
