...
Xには、[NewsClip](/NewsClip) ID文字列を指定します。(例id=help-me-again)


### 結果

指定された[NewsClip](/NewsClip) IDが正しい場合は、「ID is accepted.」と書かれたページが表示されます。過ったIDを指定した場合は、HTTPエラーコード404を返します。
...
idの値Xには、[NewsClip](/NewsClip) ID文字列を指定します。(例id=help-me-again)
